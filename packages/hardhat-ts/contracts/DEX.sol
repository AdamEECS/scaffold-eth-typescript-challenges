...
contract DEX {
   ...
   */
  event EthToTokenSwap(address indexed user, string swapType, uint256 ethInput, uint256 tokenOutput);

  /**
   * @notice Emitted when tokenToEth() swap transacted
   */
  event TokenToEthSwap(address indexed user, string swapType, uint256 tokenInput, uint256 ethOutput);

  /**
   * @notice Emitted when liquidity provided to DEX and mints LPTs.
   */
  event LiquidityProvided(address indexed user, uint256 liquidityMinted, uint256 ethInput, uint256 tokenInput);

  /**
   * @notice Emitted when liquidity removed from DEX and decreases LPT count within DEX.
   */
  event LiquidityRemoved(address indexed user, uint256 liquidityBurned, uint256 ethOutput, uint256 tokenOutput);
